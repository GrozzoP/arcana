...
1. ¿Cuántos granos hay en la casilla $n$?
2. ¿Cuántos granos hay en total en el tablero?
3. Expresá ambas respuestas usando notación matemática.
4. ¿A qué orden de complejidad $O(f(n))$ corresponde el crecimiento de la cantidad de granos?
